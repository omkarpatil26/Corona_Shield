...
import static com.omkarpatil.coronashield.R.id;
import static com.omkarpatil.coronashield.R.layout;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        {
            case id.btnsearch:
                EditText tf_location =  findViewById(id.etlocation);
                ...
                break;
            case id.btnsupermarkets:
                mMap.clear();
                String grocery = "grocery_or_supermarket";
            ...
            case id.btnpharmacy:
                mMap.clear();
                String pharmacy = "drugstore_or_pharmacy";
                ...
                break;
            case id.btnhospitals:
                mMap.clear();
                String hospitals = "hospital_or_doctor";
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        StringBuilder append = googlePlaceUrl.append("&sensor=true");
        googlePlaceUrl.append("&key="+"AIzaSyDlkSE_g8MY4GcPZycY-lvkJQSNcjwrqA8");
